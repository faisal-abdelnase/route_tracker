...
class CustomListView extends StatelessWidget {
  const CustomListView({
    super.key,
    required this.places, required this.googlMapsPlacesService,
  });
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index){
          return ListTile(
            ...
            trailing: IconButton(
              onPressed: () async {
                var placeDetails =  await googlMapsPlacesService.getPlaceDetails(placeId: places[index].placeId.toString());
              }, 
